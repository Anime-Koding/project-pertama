                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Access the Resumenya panel using your email and passcode.</p>
                                        </div>
                                    </div>
                                </div><!-- .nk-block-head -->
                                @if (session('status'))
                                ...
                                <form action="{{ route("login") }}" method="POST" class="form-validate is-alter" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input autocomplete="new-password" name="password" type="password" class="form-control form-control-lg" id="password" placeholder="Enter your passcode">
                                            @error('password')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
