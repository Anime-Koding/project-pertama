<x-dashboard>
    ...
    <div class="nk-content-body">
        <div class="card">
            <div class="card-body">
                <form action="{{ route("bcategory.store") }}" method="POST">
                    @csrf
                    <div class="row g-gs">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="category_name">Category name</label>
                                <input type="text" id="category_name" name="category_name" value="{{ old("category_name") }}" class="form-control" placeholder="write category name" required>
                                @error('category_name')
