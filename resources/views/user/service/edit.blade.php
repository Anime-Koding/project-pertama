    ...
    <div class="nk-content-body">
        <div class="card card-preview">
            <div class="card-inner">
                <form action="{{ route("service.update",$service->id) }}" method="POST" class="form-validate is-alter" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                    <div class="row g-gs">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="service_name" name="service_name" placeholder="Write service name" value="{{ old("service_name",$service->service_name) }}" required>
                                        @error('service_name')
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="icon" name="icon" placeholder="Select icon fontawsome" value="{{ old("icon",$service->icon) }}" readonly>
                                        @error('icon')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    @if($service->thumb)
                                    <img src="{{ url("storage/".$service->thumb) }}" alt="{{ $service->service_name }}">
                                    @endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <select name="status" id="status" class="form-control" required>
                                        ...
                                        <option {{ old("status",$service->status) == "0" ? "selected" : "" }} value="0">DeActive</option>
                                    </select>
                                    @error('status')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <textarea class="form-control form-control-sm" id="details" name="details" placeholder="Write detail service">{{ old("details",$service->details) }}</textarea>
                                    @error('details')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
