    ...
    <div class="nk-content-body">
        <div class="card card-preview">
            <div class="card-inner">
                <form action="{{ route("education.store") }}" method="POST" class="form-validate is-alter">
                    @csrf
                    <div class="row g-gs">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="degree_name" name="degree_name" placeholder="Write degree name" value="{{ old("degree_name") }}" required>
                                        @error('degree_name')
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="institution_name" name="institution_name" placeholder="Write institution name" value="{{ old("institution_name") }}" required>
