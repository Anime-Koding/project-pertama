    ...
    <div class="nk-content-body">
        <div class="card card-preview">
            <div class="card-inner">
                <form action="{{ route("award.store") }}" method="POST" class="form-validate is-alter">
                    @csrf
                    <div class="row g-gs">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" placeholder="Write award title" value="{{ old("title") }}" required>
                                        @error('title')
